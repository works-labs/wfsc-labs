...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Tambah Fasilitas</h1>
                <p class="text-sm font-medium text-gray-500">Add a facility displayed on the WFSC website.</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="mb-6 flex items-center gap-3">
                ...
                <h2 class="text-lg font-bold text-[var(--color-wfsc-dark)]">Facility Information</h2>
            </div>

            <div class="space-y-6">
                <div>
                    <label class="mb-2 block text-sm font-bold text-gray-600">Name <span class="text-[var(--color-wfsc-coral)]">*</span></label>
                    <input type="text" wire:model="name" placeholder="e.g. VIP Treatment Room" 
                ...
                <div>
                    ...
                    <textarea wire:model="description" rows="5" placeholder="Facility description..." 
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="flex items-start gap-6">
                        @if ($image)
                            <div class="shrink-0">
                                <img src="{{ $image->temporaryUrl() }}" alt="Preview" class="h-28 w-40 rounded-2xl object-cover shadow-sm ring-4 ring-gray-50">
                            </div>
                        @endif
                        <div class="w-full">
                ...
                <label class="inline-flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                    ...
                    <div>
                        <span class="block text-sm font-bold text-gray-800">Set as Aktif Facility</span>
                        <span class="block text-xs font-medium text-gray-500">Facility will be visible on the public website.</span>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pt-4">
            ...
            <button type="submit" wire:loading.attr="disabled" 
                ...
                <span wire:loading.remove>Simpan Fasilitas</span>
                <span wire:loading>
