...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Edit Facility</h1>
                <p class="text-sm font-medium text-gray-500">Update facility information displayed on the WFSC website.</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="update" class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-6">
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                        @if ($image)
                            <div class="shrink-0 relative">
                                ...
                                <img src="{{ $image->temporaryUrl() }}" alt="Preview" class="h-24 w-36 rounded-2xl object-cover shadow-sm ring-4 ring-gray-50">
                            </div>
                        @elseif ($facility->image)
                            <div class="shrink-0">
                                <img src="{{ Storage::url($facility->image) }}" alt="{{ $facility->name }}" class="h-24 w-36 rounded-2xl object-cover shadow-sm ring-4 ring-gray-50">
                            </div>
                        @endif
                ...
                <label class="inline-flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                    ...
                    <div>
                        <span class="block text-sm font-bold text-gray-800">Set as Active Facility</span>
        ...
        <div class="flex items-center justify-end gap-4 pt-4">
            ...
            <button type="submit" wire:loading.attr="disabled" 
                ...
                <span wire:loading.remove>Update Facility</span>
                <span wire:loading>
