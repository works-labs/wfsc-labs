...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Edit Berita</h1>
                <p class="text-sm font-medium text-gray-500">Perbarui informasi dan isi artikel.</p>
            </div>
        </div>
    </div>
    ...
    @if ($errors->any())
        <div class="rounded-2xl border border-red-100 bg-red-50 p-6 shadow-sm">
            ...
            <ul class="mt-2 list-disc space-y-1 pl-5 text-xs font-semibold text-red-600">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="mb-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-gray-400">Informasi utama yang akan ditampilkan pada halaman berita.</p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                {{-- Title --}}
                <div>
                    <label for="title" class="mb-2 block text-sm font-bold text-gray-600">Judul</label>
                    <input
                        id="title"
                        type="text"
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        <label for="category_id" class="mb-2 block text-sm font-bold text-gray-600">Kategori</label>
                        <select
                            id="category_id"
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-xs font-medium text-gray-400">
                            Pilih satu artikel yang akan ditampilkan sebagai <strong>Baca Juga</strong> di tengah artikel.
                        </p>
                        @error('baca_juga_id')
                            <p class="mt-1.5 text-xs font-bold text-red-500">{{ $message }}</p>
                        @enderror
                ...
                {{-- Excerpt --}}
                <div>
                    <label for="excerpt" class="mb-2 block text-sm font-bold text-gray-600">Ringkasan</label>
                    <textarea
                        id="excerpt"
                        wire:model="excerpt"
                        rows="4"
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-3">
                ...
                <p class="text-xs font-medium text-gray-400">
                    Gunakan Enter untuk membuat paragraf baru. Tombol <strong>P</strong> mengubah blok aktif menjadi paragraf.
                </p>
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="mb-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-gray-400">Gambar utama yang digunakan pada kartu dan halaman artikel.</p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                @if ($news->thumbnail)
                    <div>
                        <p class="mb-2 text-xs font-bold text-gray-600">Thumbnail saat ini</p>
                ...
                <div>
                    <label for="thumbnail" class="mb-2 block text-sm font-bold text-gray-600">Ganti Thumbnail</label>
                    <input
                        id="thumbnail"
                        type="file"
                    ...
                    >
                    <p class="mt-1.5 text-xs font-medium text-gray-400">
                        Kosongkan jika ingin mempertahankan thumbnail saat ini. Maksimal 2 MB.
                    </p>
                    ...
                    <div wire:loading wire:target="thumbnail" class="mt-2 text-xs font-bold text-[var(--color-wfsc-coral)] flex items-center gap-1.5">
                ...
                @if ($thumbnail)
                    <div>
                        <p class="mb-2 text-xs font-bold text-gray-600">Preview thumbnail baru</p>
                        <img
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="mb-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-gray-400">Atur status dan waktu publikasi artikel.</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                        ...
                        <div>
                            ...
                            <span class="mt-0.5 block text-xs font-medium text-gray-500">Tandai artikel sebagai artikel unggulan.</span>
                        </div>
                    </label>
                    ...
                    <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                        ...
                        <div>
                            ...
                            <span class="mt-0.5 block text-xs font-medium text-gray-500">Artikel dapat ditampilkan di halaman publik.</span>
                        </div>
                    </label>
                </div>
            </div>
