...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <form wire:submit="update" class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-6">
                {{-- Doctor (Conditional if Founder) --}}
                <div>
                    @if ($doctorHomeSection->doctor?->isFounder())
                        <label class="mb-2 block text-sm font-bold text-gray-600">Doctor</label>
                        <div class="flex items-center justify-between rounded-xl border border-amber-200 bg-amber-50/50 px-5 py-4">
                            <div>
                ...
                {{-- Section (Conditional if Founder) --}}
                <div>
                    @if ($doctorHomeSection->doctor?->isFounder())
                        <label class="mb-2 block text-sm font-bold text-gray-600">Section</label>
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    {{-- Status (Conditional if Founder) --}}
                    <div class="pt-2">
                        @if ($doctorHomeSection->doctor?->isFounder())
                            <label class="mb-2 block text-sm font-bold text-gray-600">Status</label>
