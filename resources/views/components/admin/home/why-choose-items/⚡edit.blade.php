...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Edit Why Choose Item</h1>
                <p class="text-sm font-medium text-gray-500">Update this reason displayed on the WFSC website.</p>
            </div>
        </div>
    </div>
