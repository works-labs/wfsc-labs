...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Edit Hero Banner</h1>
                <p class="text-sm font-medium text-gray-500">Update hero banner displayed on the WFSC website.</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="update" class="space-y-8">
        ...
        <div class="flex items-center justify-end gap-4 pt-4">
            ...
            >
                <span wire:loading.remove>Update Hero Banner</span>
                <span wire:loading>
