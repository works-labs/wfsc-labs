...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Add Doctor</h1>
                <p class="text-sm font-medium text-gray-500">Create a new doctor profile for the WFSC medical team.</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" wire:model="name" placeholder="e.g. Amelia Putri" 
                ...
                <div>
                    ...
                    <input type="text" wire:model="title" placeholder="e.g. dr." 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
                ...
                <div>
                    ...
                    <input type="text" wire:model="specialization" placeholder="e.g. Aesthetic Medicine" 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
                ...
                <div>
                    ...
                    <input type="text" wire:model="experience" placeholder="e.g. 8 tahun" 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea wire:model="short_bio" rows="3" placeholder="Short description displayed on doctor cards..." 
                ...
                <div>
                    ...
                    <textarea wire:model="bio" rows="6" placeholder="Full doctor biography..." 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]"></textarea>
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div>
                    ...
                    <textarea wire:model="education" rows="5" placeholder="University, medical education, etc." 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]"></textarea>
                ...
                <div>
                    ...
                    <textarea wire:model="certifications" rows="5" placeholder="Professional certifications..." 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]"></textarea>
                ...
                <div>
                    ...
                    <div class="flex items-start gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <p class="mt-2 text-xs font-medium text-gray-400">Recommended: JPG, PNG, or WebP. Maximum 5MB.</p>
        ...
        <div class="flex items-center justify-end gap-4 pt-4">
            ...
            <button type="submit" wire:loading.attr="disabled" 
                ...
                <span wire:loading.remove>Save Doctor</span>
                <span wire:loading>
