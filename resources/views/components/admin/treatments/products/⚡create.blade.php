...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Tambah Produk</h1>
                <p class="text-sm font-medium text-gray-500">
                    Add a skincare product for <span class="font-bold text-[var(--color-wfsc-coral)]">{{ $treatment->name }}</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-6">
                <div>
                    <label class="mb-2 block text-sm font-bold text-gray-600">Product Name <span class="text-[var(--color-wfsc-coral)]">*</span></label>
                    <input type="text" wire:model="name" placeholder="e.g. Glowing Serum" 
                ...
                <div>
                    ...
                    <textarea wire:model="description" rows="5" placeholder="Product description..." 
