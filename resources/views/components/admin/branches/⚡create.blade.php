...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Tambah Cabang</h1>
                <p class="text-sm font-medium text-gray-500">Add a new clinic branch and its contact information.</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-6">
                {{-- Name --}}
                <div>
                    <label class="mb-2 block text-sm font-bold text-gray-600">Branch Name <span class="text-[var(--color-wfsc-coral)]">*</span></label>
                    <input type="text" wire:model="name" placeholder="WFSC Surabaya" 
                ...
                {{-- Address --}}
                <div>
                    <label class="mb-2 block text-sm font-bold text-gray-600">Address <span class="text-[var(--color-wfsc-coral)]">*</span></label>
                    <textarea wire:model="address" rows="4" placeholder="Full branch address" 
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="grid gap-6 md:grid-cols-3">
                <div>
                    ...
                    <input type="text" wire:model="phone" placeholder="031-xxxxxxx" 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
                ...
                <div>
                    ...
                    <input type="text" wire:model="whatsapp" placeholder="628xxxxxxxxxx" 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
                ...
                <div>
                    ...
                    <input type="email" wire:model="email" placeholder="branch@example.com" 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="url" wire:model="google_maps_url" placeholder="https://maps.google.com/..." 
                        class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="number" step="0.0000001" wire:model="latitude" placeholder="-7.2575" 
                            class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.0000001" wire:model="longitude" placeholder="112.7521" 
                            class="w-full rounded-xl border-gray-200 bg-gray-50/50 px-4 py-3 text-sm transition-colors focus:bg-white focus:border-[var(--color-wfsc-coral)] focus:ring-1 focus:ring-[var(--color-wfsc-coral)]">
                ...
                <label class="inline-flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                    ...
                    <div>
                        <span class="block text-sm font-bold text-gray-800">Set as Aktif Branch</span>
