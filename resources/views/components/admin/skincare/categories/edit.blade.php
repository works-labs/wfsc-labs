...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Edit Kategori Skincare</h1>
                <p class="text-sm font-medium text-gray-500">Update this skincare category.</p>
            </div>
        </div>
    </div>
                ...
                <div>
                    ...
                    @if ($existingImage)
                        <div class="mb-4 flex items-center gap-4">
                            <img src="{{ Storage::url($existingImage) }}" alt="{{ $name }}" class="h-28 w-28 rounded-2xl object-cover shadow-sm ring-4 ring-gray-50">
                            <button type="button" wire:click="removeImage" wire:confirm="Apakah Anda yakin ingin menghapus data ini?"
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                        @if ($image)
                            <div class="shrink-0 relative">
                                ...
                                <img src="{{ $image->temporaryUrl() }}" alt="New preview" class="h-24 w-24 rounded-2xl object-cover shadow-sm ring-4 ring-gray-50">
                            </div>
                        @endif
                        ...
                        <div class="w-full">
                            ...
                            <p class="mt-2 text-xs font-medium text-gray-400">Upload a new image to replace the current one. Maximum 2 MB.</p>
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div class="flex items-center pt-8">
                        <label class="inline-flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 w-full transition-colors hover:bg-gray-100">
                            ...
                            <div>
                                <span class="block text-sm font-bold text-gray-800">Aktif Category</span>
