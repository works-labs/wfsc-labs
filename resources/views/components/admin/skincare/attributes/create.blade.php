...
<div class="mx-auto max-w-4xl space-y-8 pb-10">
    ...
    <div>
        ...
        <div class="mt-4 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black tracking-tight text-[var(--color-wfsc-dark)]">Tambah Atribut Skincare</h1>
                <p class="text-sm font-medium text-gray-500">Create a new attribute for skincare products.</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-8 elegant-shadow">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" wire:model.live="name" placeholder="Sunscreen" 
                ...
                <div>
                    ...
                    <input type="text" wire:model="slug" readonly tabindex="-1" placeholder="sunscreen"
                        class="w-full cursor-not-allowed rounded-xl border-gray-200 bg-gray-100 px-4 py-3 font-mono text-sm text-gray-500">
                    <p class="mt-1.5 text-xs font-medium text-gray-400">Slug dibuat otomatis berdasarkan nama attribute.</p>
                ...
                <div>
                    ...
                    <textarea wire:model="description" rows="4" placeholder="Products that provide sun protection..." 
                ...
                <label class="inline-flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4 w-full transition-colors hover:bg-gray-100">
                    ...
                    <div>
                        <span class="block text-sm font-bold text-gray-800">Aktif Attribute</span>
                        <span class="block text-xs font-medium text-gray-500">Nonaktif attributes won't be available for product assignment.</span>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pt-4">
            ...
            <button type="submit" wire:loading.attr="disabled" 
                ...
                <span wire:loading.remove>Buat Atribut</span>
                <span wire:loading>
